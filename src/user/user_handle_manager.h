...
namespace user
{
class user_handle_manager : public node
{
...
public:
    ...
    int find_id( network::client_handle handle );
    int find_id( network::network_handle handle );
    int find_tcp_port( network::network_handle handle );
    int find_udp_port( network::client_handle handle );
